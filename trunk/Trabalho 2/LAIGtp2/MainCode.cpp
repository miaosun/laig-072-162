...
double dx=26.0/2, dy=2.0/2, dz=6.0/2;
double dx1=22.0/2;

double tx=8.0/2, ty=3.0/2, tz=4.0/2;
...
void base()
{
	...
	/*glBegin(GL_POLYGON);
		glNormal3d(0.0,0.0,-1.0);
		glVertex3d(15.0,0.0,-3.0);
		glVertex3d(19.0,-4.0,-5.0);
		glVertex3d(11.0,-4.0,-5.0);
	glEnd();*/
...
void display(void)
{
	...
	glLoadIdentity();
	glFrustum( -xy_aspect*.04, xy_aspect*.04, -.04, .04, .1, 250.0 );
